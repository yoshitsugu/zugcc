...
assert 1 'int main() { return sub_short(7, 3, 3); }'
...
assert 3 'int main() { typedef int MyInt; MyInt x=3; return x; }'
assert 16 'int main() { typedef int MyInt2[4]; MyInt2 x; return sizeof(x); }'
